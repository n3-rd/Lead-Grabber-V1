		...
		<div class="grid grid-cols-3 gap-2 py-2">
			{#each keys as k}
				<button
					type="button"
					onclick={() => handleKey(k)}
					class="flex h-12 items-center justify-center rounded-lg border border-[#969696] bg-white font-['Poppins'] text-xl font-medium text-[#808080] transition-colors hover:bg-[#ECF3FF] hover:border-[#577AB7] hover:text-[#577AB7] active:scale-95"
				>
					{k}
				</button>
			{/each}
