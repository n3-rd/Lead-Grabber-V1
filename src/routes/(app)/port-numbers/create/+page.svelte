<script lang="ts">
	...
	// Mock data for portability results
	const portabilityResults = [
		{ number: '+1 705 243 8416', status: 'Portable', carrier: 'Northerntel Limited Partnership', numberType: 'Local' }
	];
